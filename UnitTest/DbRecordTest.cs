  ...
  public class DbRecordTest : BaseDbTest
  {
    ...
    private void RunJoinManyOne(TestDb db)
    {
      ...
      using (var conn = db.Adapter.CreateConnection())
      {
        conn.Open();
        var shops = conn.FetchRecordSet<Test.Orm.Shop>(select);
        Assert.Equal(1, Sdx.Context.Current.DbProfiler.Logs.Count);
    ...
    private void RunNoJoinManyOne(TestDb db)
    {
      ...
      using (var conn = db.Adapter.CreateConnection())
      {
        ...
        Assert.Equal(2, Sdx.Context.Current.DbProfiler.Logs.Count);
        ...
        Assert.Equal(3, Sdx.Context.Current.DbProfiler.Logs.Count);
    ...
    private void RunNoJoinManyMany(TestDb db)
    {
      ...
      using (var conn = db.Adapter.CreateConnection())
      {
        ...
        Assert.Equal(5, Sdx.Context.Current.DbProfiler.Logs.Count);
        ...
        Assert.Equal(6, Sdx.Context.Current.DbProfiler.Logs.Count);
        ...
        Assert.Equal(9, Sdx.Context.Current.DbProfiler.Logs.Count);
      }
    }
